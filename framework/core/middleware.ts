...
export type Middleware = (ctx: MiddlewareContext, next: () => Promise<Response>) => Promise<Response>;

export type OnRequestMiddleware = (ctx: MiddlewareContext, next: () => Promise<Response>) => Promise<Response>;
export type OnResponseMiddleware = (ctx: MiddlewareContext, next: () => Promise<Response>) => Promise<Response>;
