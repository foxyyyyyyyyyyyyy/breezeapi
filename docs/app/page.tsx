          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <a href="https://github.com/foxyyyyyyyyyyyyy/breezeapi" className="text-slate-400 hover:text-teal-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                ...
                <a href="https://twitter.com/fabi98_6" className="text-slate-400 hover:text-teal-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
